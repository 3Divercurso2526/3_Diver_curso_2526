    ...
    const aulaContent = {
        1: `
            ...
            <div class="storybook-section">
                <h4>🚀 Misión del Proyecto: Laboratorio Digital</h4>
                <p>¡Bienvenidos, desarrolladores! Vuestra misión, si decidís aceptarla, es crear una <strong>aplicación educativa digital</strong>. El objetivo: ayudar a otros estudiantes a responder las grandes preguntas: <em>¿De qué estamos hechos? ¿Cuáles son los ladrillos del universo?</em> Usaréis la ciencia como guía y la tecnología como herramienta para construir una app interactiva que haga el aprendizaje más fácil y divertido. ¡El conocimiento está en vuestras manos!</p>
                <p class="mt-2"><a href="https://g.co/gemini/share/aed90c01acdc" target="_blank" class="text-amber-700 font-semibold hover:underline">Recurso de inspiración →</a></p>
            </div>
        ...
        2: `
            ...
            <div class="storybook-section">
                <h4>🛰️ Misión del Proyecto: Sonda Celular</h4>
                <p>¡Equipo de bio-ingenieros! Hemos recibido una transmisión urgente desde el interior de un organismo vivo. Necesitamos que construyáis una <strong>sonda digital (una app)</strong> para explorar la unidad más básica de la vida: la célula. Vuestra misión será navegar por su interior, identificar sus componentes (los orgánulos), entender cómo se comunican y descubrir cómo se organizan para formar equipos más grandes (los tejidos). Además, tendréis que analizar el lenguaje químico que usan para funcionar: los iones. ¡El viaje al microcosmos empieza ahora!</p>
                <p class="mt-2"><a href="https://g.co/gemini/share/9fdb14e87f8b" target="_blank" class="text-amber-700 font-semibold hover:underline">Recurso de inspiración →</a></p>
            </div>
            ...
            <h3>6. Secuencia de sesiones (30 × 55 min aprox.)</h3>
            <ol class="list-decimal list-inside pl-1 space-y-2">
                <li><strong>Fase 0 · Arranque:</strong> Diagnóstico de ideas previas y reparto de roles.</li>
                <li><strong>Fase 1 · Base conceptual:</strong> Célula, orgánulos, tejidos, iones y números enteros.</li>
                <li><strong>Fase 2 · Visual Coding básico:</strong> Esqueleto de la app, eventos, variables y prototipo de tarjeta.</li>
                <li><strong>Fase 3 · Diseño centrado en contenido:</strong> Guion de pantallas, redacción de textos y prototipo alfa.</li>
                <li><strong>Fase 4 · Profundización y “IonLab”:</strong> Implementación de “IonLab”, pruebas y ampliación del quiz.</li>
                <li><strong>Fase 5 · Calidad y accesibilidad:</strong> Revisión de accesibilidad y optimización.</li>
                <li><strong>Fase 6 · Cierre y defensa:</strong> Preparación de póster/vídeo, ensayo y feria de proyectos.</li>
            </ol>

            <h3>7. Rúbrica de evaluación del proyecto</h3>
            <div class="overflow-x-auto">
                <table>
                    <thead>
                        <tr>
            ...
            <h3>8. Materiales, Tareas y Cuestionarios</h3>
            <p>Todos los materiales de apoyo, tareas (prototipo alfa, entrega final), glosarios y cuestionarios se gestionarán a través del <strong>aula virtual de Moodle</strong>.</p>
        `,
        3: `
            ...
            <div class="storybook-section">
                <h4>🩺 Misión del Proyecto: Salud a Medida</h4>
                <p>¡Equipo de analistas de datos! El Centro de Salud local necesita nuestra ayuda. Quieren crear una <strong>herramienta digital interactiva</strong> para explicar a los jóvenes cómo los pequeños hábitos, si se repiten, pueden tener un gran impacto en la salud (¡como una progresión matemática!). Vuestra misión es diseñar una app que no solo enseñe hábitos saludables, sino que también nos ayude a entender cómo medimos nuestro mundo: desde un plano a escala hasta el error que cometemos al medir. ¡Vamos a demostrar que las matemáticas y la salud van de la mano!</p>
                <p class="mt-2"><a href="https://g.co/gemini/share/627fd3a552cf" target="_blank" class="text-amber-700 font-semibold hover:underline">Recurso de inspiración →</a></p>
            </div>
