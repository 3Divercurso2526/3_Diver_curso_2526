document.addEventListener('DOMContentLoaded', () => {
    ...
    const aulaContent = {
        1: `
            ...
            <p>¡Bienvenidos al Proyecto 1: Laboratorio Digital! En esta primera aventura, nos convertiremos en <strong>desarrolladores de aplicaciones</strong>. Nuestra misión será crear una herramienta digital interactiva que ayude a otros estudiantes a entender las preguntas más fundamentales: <strong>¿De qué estamos hechos? ¿Cuáles son los ladrillos básicos de la vida y del universo?</strong> Para lograrlo, exploraremos la composición de los seres vivos, la estructura de la materia y usaremos las matemáticas como lenguaje universal. Al final, cada equipo tendrá su propia mini-app funcional, poniendo la tecnología al servicio de la ciencia.</p>
